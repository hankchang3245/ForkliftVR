...
namespace Valve.VR.InteractionSystem
{
	...
	public class CircularDrive : MonoBehaviour
	{
		...
		private OVRHand handHoverLocked = null;

        //private Interactable interactable;

		//-------------------------------------------------
		private void Freeze(OVRHand hand )
		{
			frozen = true;
		...
		//-------------------------------------------------
		private IEnumerator HapticPulses( OVRHand hand, float flMagnitude, int nCount )
		{
			if ( hand != null )
			{
		...
		//-------------------------------------------------
		private void HandHoverUpdate(OVRHand hand )
        {
		...
		*/
		...
		//-------------------------------------------------
		private void ComputeAngle( OVRHand hand )
		{/*
