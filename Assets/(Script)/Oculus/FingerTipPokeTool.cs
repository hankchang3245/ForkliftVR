...
namespace Oculus
{
	...
	public class FingerTipPokeTool : InteractableTool
	{
		...
		private void Update()
		{
			...
			Vector3 capsuleTipPosition = capsuleTransform.position + _capsuleToTrack.CapsuleCollider.height * 0.5f * capsuleDirection;
			Vector3 toolSphereRadiusOffsetFromTip = currentScale * _fingerTipPokeToolView.SphereRadius * capsuleDirection;
