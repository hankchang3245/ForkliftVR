...
namespace Oculus
{
	...
	public class TrainButtonVisualController : MonoBehaviour
	{
		...
		private void ActionOrInContactZoneStayEvent(ColliderZoneArgs collisionArgs)
		{
			...
			Vector3 localSpacePosition = _buttonContactTransform.InverseTransformPoint(interactionPosition);
			...
			if (scaledLocalSpaceOffset > -_contactMaxDisplacementDistance && scaledLocalSpaceOffset <= 0.0f)
			{
		...
		private IEnumerator ResetPosition()
		{
			...
			{
				transform.localPosition = Vector3.Lerp(transform.localPosition, _oldPosition, (Time.time - startTime) / LERP_TO_OLD_POS_DURATION);
				yield return null;
			}
