...
namespace Oculus
{
	...
	public class ButtonController : Interactable
	{
		  ...
		  InteractableCollisionDepth newCollisionDepth)
		{
			...
			{
				upcomingState = toolInContactZone ? InteractableState.ContactState : toolInActionZone ? InteractableState.ActionState : InteractableState.Default;
			}
			else
			{
				...
				bool onPositiveSideOfButton = !_makeSureToolIsOnPositiveSide || buttonZonePlane.GetSide(interactableTool.InteractionPosition);
			...
			if (oldState != upcomingState)
			{
				...
				var interactionType = !switchingStates ? InteractionType.Stay : newCollisionDepth == InteractableCollisionDepth.None ? InteractionType.Exit :
